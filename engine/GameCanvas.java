...
public abstract class GameCanvas extends Canvas implements Runnable, Drawable {
    ...
    public GameCanvas() {}
    public abstract void update(float elapsedTime) throws RemoteException;
    public abstract void draw(Graphics g, float elapsedTime) throws RemoteException; // Все что описано в это функции будет отрисовано в рендер.
